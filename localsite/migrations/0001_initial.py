...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('localsite_fournisseur', (
            ...
            ('picture', self.gf('satchmo_utils.thumbnail.field.ImageWithThumbnailField')(max_length=200, name_field='name', null=True, blank=True)),
        ))
        db.send_create_signal('localsite', ['Fournisseur'])

        # Adding M2M table for field product on 'Fournisseur'
        db.create_table('localsite_fournisseur_product', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('fournisseur', models.ForeignKey(orm['localsite.fournisseur'], null=False)),
            ('product', models.ForeignKey(orm['product.product'], null=False))
        ))
        db.create_unique('localsite_fournisseur_product', ['fournisseur_id', 'product_id'])


    def backwards(self, orm):
        
        # Deleting model 'Fournisseur'
        db.delete_table('localsite_fournisseur')

        # Removing M2M table for field product on 'Fournisseur'
        db.delete_table('localsite_fournisseur_product')
